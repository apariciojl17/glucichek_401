...
public class ModifyPatientPageObject extends BasePage {
	...
	private final static By locStepTHREEAssociatedProfessionalInputsForRead          = By.xpath("//*[@id='AppContainer']/div[1]/div/div[3]/div[2]/form/div/div[1]/div/div[2]/div/div/div/div[2]/div/div/span[1]/div/span[@class='Select-value-label']");   
	                                                                                             //*[@id='AppContainer']/div[1]/div/div[3]/div[2]/form/div/div[1]/div/div[2]/div/div/div/div[2]/div/div/span[1]/div
	// #AppContainer > div.sc-EHOje.eYfocG > div > div.sc-hQfrgq.fMkqRY > div.sc-fUdGnz.jAwdtU > form > div > div.sc-ldcLGC.kcrZHj > div > div:nth-child(2) > div > div > div > div:nth-child(2) > div > div > span.Select-multi-value-wrapper > div:nth-child(1) > span.Select-value-label
	...
	public ModifyPatientPageObject(String _expectedPageTitle, WebDriver mainWebDriver) {
	...
	public void waitUntilHealthCareIDRequiredApeears(String textToExpect) {
		fluentWait(locStepTWOHealthCareIDRequiredLabel);
  
		WebDriverWait wait = new WebDriverWait(this.driver, 30);
		wait.until(ExpectedConditions.textToBePresentInElementLocated(locStepTWOHealthCareIDRequiredLabel, textToExpect));  
	}
